                ...
                <div class="modal-content">
                    <div class="wrapper" id="reservaForm">
                        <form class="reserva-form" id="formReservaAdmin"
                            action="../../controlador/torneo/editarTorneo.php" method="POST">
                            <center>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" id="id" name="id" class="form-input" value="<?= $row['id_equipo'] ?>" required />
                                <input type="text" id="nombre" name="nombre" class="form-input" value="<?= $row['nombre'] ?>" required />
                            </div>
                            <div class="form-group">
                                <label class="form-label">Grupo</label>
                                <select id="grupo" name="grupo" class="form-input" required>
                                    <option value="<?= $row['nombre'] ?>">Selecciona el grupo</option>
