...
$conn = conexion();
$id = $_GET['id'];
$sql = "SELECT * FROM partidos WHERE id_partido='$id'";
                ...
                <div class="modal-content">
                    <div class="wrapper" id="reservaForm">
                        <form class="reserva-form" id="formReservaAdmin"
                            action="../../controlador/torneo/editarResultado.php" method="POST">
                            <center>
                                <h2>Editar resultado del encuentro</h2>
                            </center>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    <input type="hidden" id="id" name="id" class="form-input" value="<?= $roww['id_partido'] ?>" required />
                                    <label class="form-label">Equipo Local</label>
                                    <select id="local" name="local" class="form-input" required>
                                        <option value="<?= $roww['id_equipo_local'] ?>">Selecciona el grupo</option>
                                        <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="gol" name="gol" class="form-input" value="<?= $roww['goles_local'] ?>" required />
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <select id="visitante" name="visitante" class="form-input" required>
                                        <option value="<?= $roww['id_equipo_visitante'] ?>">Selecciona el grupo</option>
                                        <?php
                                        $sql = "SELECT * FROM equipos";
                                        $query = mysqli_query($conn, $sql);
                                        while ($row = mysqli_fetch_array($query)) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="golv" name="golv" class="form-input" value="<?= $roww['goles_visitante'] ?>" required />
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group">
                                    <label class="form-label">Fecha</label>
                                    <input type="date" id="fecha" name="fecha" class="form-input" value="<?= $roww['fecha'] ?>"required />
                                </div>
                                <div class="form-group">
                                    ...
                                    while ($row = mysqli_fetch_array($query)) { ?>
                                        ...
                                        <input type="text" id="" name="" class="form-input"
                                            placeholder="<?= $row['nombre'] ?>" required readonly />
