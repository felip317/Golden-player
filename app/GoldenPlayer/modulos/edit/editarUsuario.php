                ...
                <div class="modal-content">
                    <div class="wrapper" id="reservaForm">
                        <form class="reserva-form" id="formReservaAdmin"
                            action="../../controlador/usuarios/editarUsuario.php" method="POST">
                            <center>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="username" name="username" class="form-input"
                                    placeholder="Tu nombre de usuario" value="<?= $row['username'] ?>" required />
                            </div>
                            <div class="form-group">
                                <label class="form-label">Correo Electronico</label>
                                <input type="email" id="email" name="email" class="form-input"
                                    placeholder="tu@email.com" value="<?= $row['email'] ?>"required />
                            </div>
