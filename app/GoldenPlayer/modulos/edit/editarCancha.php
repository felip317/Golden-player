                ...
                <div class="modal-content">
                    <div class="wrapper" id="reservaForm">
                                <form class="reserva-form" id="formReservaAdmin"
                                    action="../../controlador/canchas/editarCancha.php" method="POST">
                                    <center>
                                        <h2>Actualiza tu cancha</h2>
                                    </center>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="precio" name="precio" class="form-input"
                                                placeholder="precio sin puntos" value="<?= $row ['precio']?>" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="descripcion" name="descripcion" class="form-input"
                                                placeholder="Descripcion" value="<?= $row ['descripcion']?>" required />
                                        </div>

                                        <div class="form-group">
                                            <label class="form-label">Capacidad</label>
                                            <input type="text" id="capacidad" name="capacidad" class="form-input"
                                                placeholder="En jugadores" value="<?= $row ['capacidad']?>" />
                                        </div>
                                    </div>
